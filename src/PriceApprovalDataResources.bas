Attribute VB_Name = "PriceApprovalDataResources"
'@Folder("Constants")
Option Explicit
...
Private Function DatabaseFilePath_Access() As String
    DatabaseFilePath_Access = ThisWorkbook.Path & Application.PathSeparator & "database" _
                              & Application.PathSeparator & "DB-MSAccess" & Application.PathSeparator & "PriceApproval.accdb"
End Function
